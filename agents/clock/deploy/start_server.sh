...
# Clock Agent Startup Script
# Fetches secrets from AWS Secrets Manager and starts the Clock Agent.
...
echo "Starting Clock Agent on port $PORT..."

SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
# Project root is three levels up: agents/clock/deploy/ -> root
